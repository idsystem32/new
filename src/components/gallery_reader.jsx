...
class GalleryReader extends Component {
    ...
    computeImageUrl() {
        ...
        return `https://proxy.duckduckgo.com/iu/?u=https://i.nhentai.net/galleries/${this.state.media_id}/${this.state.page}.${image_type[this_type]}`;
    }
    ...
    preloadImage() {
        ...
        while (page <= this.state.images.length && this.preloadArr.length < 3) {
            ...
            let image = new Image();
            image.src = `https://proxy.duckduckgo.com/iu/?u=https://i.nhentai.net/galleries/${this.state.media_id}/${page}.${image_type[this_type]}`;
